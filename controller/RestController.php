...
/** Vocabulary-specific methods **/
    ...
    private function transformLookupResults($lang, $hits, $label)
    {
        ...
        $ret = array_merge_recursive($this->context, array(
            '@context' => array('onki' => 'http://schema.onki.fi/onki#', 'results' => array('@id' => 'onki:results'), 'prefLabel' => 'skos:prefLabel', 'altLabel' => 'skos:altLabel', 'hiddenLabel' => 'skos:hiddenLabel','notation' => 'skos:notation'),
            'result' => $hits)
        );
