...
class WebController extends Controller
{
    ...
    /**
     * Invokes the structure search page .
     */
    public function invokeStructurePage($request)
    {
        $template = $this->twig->loadTemplate('structure.twig');
        echo $template->render(
            array(
                'request' => $request,
            ));
    ...
    /**
     * Invokes the SPARQL search page .
     */
    public function invokeSparqlPage($request)
    {
        $template = $this->twig->loadTemplate('sparql.twig');
        echo $template->render(
            array(
                'request' => $request,
            ));
    ...
    /**
     * Invokes the about us page .
     */
    public function invokeFaboutPage($request)
    {
        $template = $this->twig->loadTemplate('fabout.twig');
        echo $template->render(
            array(
                'request' => $request,
            ));
    ...
    /**
     * Invokes the terms of use page .
     */
    public function invokeFtermsPage($request)
    {
        $template = $this->twig->loadTemplate('fterms.twig');
        echo $template->render(
            array(
                'request' => $request,
            ));
    ...
    /**
     * Invokes the contact page .
     */
    public function invokeFcontactPage($request)
    {
        $template = $this->twig->loadTemplate('fcontact.twig');
        echo $template->render(
            array(
                'request' => $request,
            ));
    ...
    /**
     * Invokes the publication page .
     */
    public function invokeFpublicationPage($request)
    {
        $template = $this->twig->loadTemplate('fpublication.twig');
        echo $template->render(
            array(
                'request' => $request,
            ));
