...
class Concept extends VocabularyDataObject
{
    ...
    /**
     * Returns a definition for the concept or null if it has not been defined.
     * @return string eg. '999'
     */
    public function getDefinition()
    {
        $definition = $this->resource->get('skos:definition');
        if ($definition !== null) {
    ...
    /**
     * Returns an example for the concept or null if it has not been defined.
     * @return string eg. '999'
     */
    public function getExample()
    {
        $example = $this->resource->get('skos:example');
        if ($example !== null) {
    ...
    /**
     * Returns an array of see also for the concept or null if it has not been defined.
     * @return string eg. '999'
     */
    public function getSeeAlso()
    {
        $seeAlso = $this->resource->all('rdfs:seeAlso');
        ...
        //return var_dump($seeAlso[1]->getUri());
        /*if ($seeAlso !== null) {
            //return $seeAlso->getUri();
            //return var_dump($seeAlso->getUri());
            $array = $seeAlso->toRdfPhp();
    ...
    {
        $seeAlso = $this->resource->all('skos:altLabel');
    ...
    {
        $seeAlso = $this->resource->all('owl:sameAs');
    ...
    {
        $seeAlso = $this->resource->all('skos:exactMatch');
    ...
    {
        $mass = $this->resource->get('dbp:molecularWeight');
        if ($mass !== null) {
    ...
    {
        $mass = $this->resource->get('dbp:inchikey');
        if ($mass !== null) {
            return $mass->getValue();
        }
    ...
    {
        $mass = $this->resource->get('c:searchSds');
        if ($mass !== null) {
            return $mass->getUri();
        }
    ...
    {
        $mass = $this->resource->get('c:searchSp');
        if ($mass !== null) {
            return $mass->getUri();
        }
    ...
    {
        $mass = $this->resource->get('c:searchPubMed');
        if ($mass !== null) {
            return $mass->getUri();
        }
    ...
    {
        $mass = $this->resource->get('c:searchGoogleScholar');
        if ($mass !== null) {
            return $mass->getUri();
        }
    ...
    {
        $mass = $this->resource->get('c:searchGoogleBooks');
        if ($mass !== null) {
            return $mass->getUri();
        }
    ...
    {
        $mass = $this->resource->get('c:searchChemSpider');
        if ($mass !== null) {
            return $mass->getUri();
        }
    ...
    {
        $mass = $this->resource->get('dbp:casNumber');
        if ($mass !== null) {
            return $mass->getValue();
        }
    ...
    {
        $mass = $this->resource->get('dbp:inchi');
        if ($mass !== null) {
            return $mass->getValue();
        }
